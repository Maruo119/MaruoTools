...
def grep():
    ...
    return render_template('results_v6.html', results=results_data)
...
def file_content():
    ...
    return render_template("result_file_content_v6.html", file_path=file_path, content=content, results=results)
